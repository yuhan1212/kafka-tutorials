Let's augment our existing configuration file that was created after you provisioned a new ``ccloud-stack``. Do this by appending the following to the end of your configuration file.
